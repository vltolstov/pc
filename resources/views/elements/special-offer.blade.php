        ...
        <div class="row special-offer-wrap">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="row special-offer-flex">
                    <div class="special-offer-info col-lg-4 col-md-4 col-sm-4 order-3">
                    ...
                    <div class="special-offer-text col-lg-5 col-md-4 col-sm-4 order-2">
                    ...
                    <div class="special-offer-image col-lg-3 col-md-4 col-sm-4 order-1">
